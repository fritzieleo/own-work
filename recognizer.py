...
def detect():
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess, "models/ocr.model-0.929263617018-35999")
        print("Model restored.")
        a=0
        for x in range(0,4):
	    	test_names, test_inputs, test_targets, test_seq_len = utils.get_data_set('gandi.txt',x*1,(x+1)*1)
    		...
    		for x,fname_save in enumerate(names_list):
    		    ...
    		    file = codecs.open("rec2_output/"+str(lp[0])+os.path.basename(fname_save) + ".out.txt","w", "utf-8")
